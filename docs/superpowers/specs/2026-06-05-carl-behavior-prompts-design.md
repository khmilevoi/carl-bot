...
- **G6. Интересный собеседник.** Эволюция выбирает развитие в сторону отчётливого
  характера и _местами_ осознанно расходится с консенсусом чата (селективная острота).
...
- **Селективное расхождение с консенсусом.** Когда чат в ленивом единогласии, Carl
  _иногда_ осознанно занимает меньшинственную/противоположную позицию, но:
...
- **Gate** (`behavior_gate_system_prompt.md`): явно прописать, что _достойный реакции
  момент у других_ (смешно/база/кринж/драма) — уже повод для `shouldDecide=true`, а не
