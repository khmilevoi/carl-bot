...
- `/getkey` запрашивает у администратора ключ доступа к данным.
- `/export <key>` выгружает содержимое базы данных в CSV при наличии доступа.
- `/approve <chatId>` — команда администратора для выдачи ключа.
