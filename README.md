...
- `/getkey` запрашивает у администратора доступ к данным.
- `/export` выгружает содержимое базы данных в CSV при наличии доступа. Ключ привязан к чату и действует 24 часа.
- `/approve <chatId>` — команда администратора для выдачи временного доступа.
